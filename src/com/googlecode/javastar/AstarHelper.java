...
public abstract class AstarHelper<N extends Node, C extends Cost<C>> {
	 ...
	 *
	 * @param node the node to calculate the heuristic value from
	 ...
	 * @throws NodesNotAdjacentException If <code>from</code> and <code>to</code> are not adjacent.
	 ...
	 *
	 * @param numberOfNodesExpanded   the total number of nodes expanded until now
	 * @param costOfCurrentNode       the cost of the node to be expanded next
	 * @param heuristicOfCurrentNode  the heuristic value of the node to be expanded next
	 * @param pathLengthOfCurrentNode the path length to the node to be expanded next
